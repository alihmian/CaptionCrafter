...
def generate_news_image(
    ...
    base_image_path = f"./assets/Base/Base1-{min(event_count, 3)}.png"
    ...
    Headline_position = ((base_image.size[0] - Headline_width) // 2, 185)
...
#     SubHeadline="نوسان سکه رفاه در حوالی قله و چشم انداز آینده بازار، تحلیلگران رشد بیشتری را پیش بینی می‌کنند.",
