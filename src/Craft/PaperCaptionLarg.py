...
def generate_news_image(
    ...
    event3="",
    days_into_future=0,
    Headline_font_size=130,
    SubHeadline_font_size=130,
    ...
    Headline_position = ((base_image.size[0] - Headline_width) // 2, 750)
...
#     SubHeadline="نوسان سکه رفاه در حوالی قله و چشم انداز آینده بازار، تحلیلگرانران رشد بیشتری را پیش بینی می‌کننتحلیلگران د.",
